...
const NotFoundPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-tr from-slate-100 via-slate-50 to-emerald-50/30 px-4">
      <div className="max-w-md w-full text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          <Link
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 rounded-xl text-sm font-semibold text-white transition-all shadow-sm hover:shadow active:scale-95"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-12 flex items-center justify-center gap-2 text-slate-400">
          <div className="w-6 h-6 rounded-lg bg-gradient-to-tr from-emerald-500 to-emerald-600 flex items-center justify-center text-white font-bold text-xs">
            C
          </div>
